...
**This is the recommended installation approach for most users.** Conda provides fast, reliable installation with pre-built PyTorch3D wheels (~10 minutes total).

For alternative installation using Python venv, see [SETUP_ALTERNATIVE.md](SETUP_ALTERNATIVE.md) (may take 30+ minutes due to PyTorch3D compilation).
