...
sample_iterator = SampleIterator(data_path, target_path, ["cuts", "holes"])

# Process each sample
for mesh_data in sample_iterator:
    if mesh_data.name != "cuts_cat_shape_10":
        continue
